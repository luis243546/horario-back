...
//                        .requestMatchers("/api/protected/me/**").hasAnyRole("TEACHER", "ASSISTANT", "COORDINATOR")
//
//                        // ==================== PERÍODOS ACADÉMICOS (✅ NUEVO) ====================
//                        // ✅ Todos los roles autenticados pueden consultar el período activo
//                        .requestMatchers(HttpMethod.GET, "/api/protected/periods/active").hasAnyRole("TEACHER", "ASSISTANT", "COORDINATOR")
//
//                        // ==================== ENDPOINTS PARA DOCENTES ====================
//                        // ✅ Docentes pueden ver sus propias clases asignadas
//                        .requestMatchers(HttpMethod.GET, "/api/protected/class-sessions/teacher/**").hasAnyRole("TEACHER", "ASSISTANT", "COORDINATOR")
//
//                        // ✅ Docentes pueden gestionar su propia asistencia
//                        .requestMatchers(HttpMethod.GET, "/api/protected/teacher-attendances/teacher/**").hasAnyRole("TEACHER", "ASSISTANT", "COORDINATOR")
//                        .requestMatchers(HttpMethod.POST, "/api/protected/teacher-attendances/check-in").hasAnyRole("TEACHER", "ASSISTANT", "COORDINATOR")
//                        .requestMatchers(HttpMethod.POST, "/api/protected/teacher-attendances/check-in-with-schedule").hasAnyRole("TEACHER", "ASSISTANT", "COORDINATOR")
//                        .requestMatchers(HttpMethod.PATCH, "/api/protected/teacher-attendances/*/check-out").hasAnyRole("TEACHER", "ASSISTANT", "COORDINATOR")
//
//                        // ✅ Docentes pueden consultar feriados
//                        .requestMatchers(HttpMethod.GET, "/api/protected/calendar-exceptions/is-holiday/**").hasAnyRole("TEACHER", "ASSISTANT", "COORDINATOR")
//                        .requestMatchers(HttpMethod.GET, "/api/protected/calendar-exceptions/date/**").hasAnyRole("TEACHER", "ASSISTANT", "COORDINATOR")
//
//                        // ✅ Solo administradores pueden aprobar/modificar asistencias
//                        .requestMatchers(HttpMethod.PATCH, "/api/protected/teacher-attendances/*/approve").hasAnyRole("ASSISTANT", "COORDINATOR")
//                        .requestMatchers(HttpMethod.PATCH, "/api/protected/teacher-attendances/*/override").hasAnyRole("ASSISTANT", "COORDINATOR")
//                        .requestMatchers(HttpMethod.PATCH, "/api/protected/teacher-attendances/*/mark-holiday").hasAnyRole("ASSISTANT", "COORDINATOR")
//                        .requestMatchers(HttpMethod.PATCH, "/api/protected/teacher-attendances/*/reject").hasAnyRole("ASSISTANT", "COORDINATOR")
//
...
//                        .hasAnyRole("ASSISTANT", "COORDINATOR")
                        ...
                        .hasAnyRole("COORDINATOR", "ASSISTANT")
